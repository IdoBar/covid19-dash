...
plot <- ggplot(plot_data, aes(x=DateRep, y=Cases, colour=Country)) +
  ...
  labs(x="Date", y="Confirmed Cases", title = "New confirmed Covid 19 cases", subtitle = "Showing 10 most affected countries + Australia") +
  theme_bw(16)
# show an interactive plot
ggplotly(plot, width = 800, height = 600)
```
